...
export class GetAnswerRequest {
	...
	constructor(_value) {
		...
		this.text = _value.text ? new ondewoNlu012.TextInput(_value.text) : undefined;
...
export class GetAnswerResponse {
	...
	constructor(_value) {
		_value = _value || {};
		this.queryResult = _value.queryResult ? new ondewoNlu012.DetectIntentResponse(_value.queryResult) : undefined;
