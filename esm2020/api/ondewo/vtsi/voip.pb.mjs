...
export class CreateProjectConfigsRequest {
    ...
    constructor(_value) {
        ...
        this.projectConfigs = _value.projectConfigs
            ? new ProjectConfigs(_value.projectConfigs)
            : undefined;
    ...
    options) {
        return {
            projectId: this.projectId,
            projectConfigs: this.projectConfigs
                ? this.projectConfigs.toProtobufJSON(options)
                : null
        };
    }
}
...
export class GetProjectConfigsResponse {
    ...
    constructor(_value) {
        ...
        this.request = _value.request
            ? new GetProjectConfigsRequest(_value.request)
            : undefined;
...
export class StartCallerRequest {
    ...
    constructor(_value) {
        _value = _value || {};
        this.sipConfig = _value.sipConfig
            ? new SIPCallerConfig(_value.sipConfig)
            : undefined;
        this.servicesConfigs = _value.servicesConfigs
            ? new CommonServicesConfigs(_value.servicesConfigs)
            : undefined;
...
export class GetVoipCallInfoRequest {
    ...
    options) {
        return {
            projectId: this.projectId,
            callId: this.callId,
            voipCallInfoView: VoipCallInfoView[this.voipCallInfoView === null || this.voipCallInfoView === undefined
                ? 0
                : this.voipCallInfoView]
        };
    }
}
...
export class GetVoipCallInfoResponse {
    ...
    constructor(_value) {
        ...
        this.activeLog = _value.activeLog
            ? new VoipCallInfo(_value.activeLog)
            : undefined;
...
export class VoipCallInfo {
    ...
    constructor(_value) {
        ...
        this.sipStatus = _value.sipStatus
            ? new ondewoSip010.SipStatus(_value.sipStatus)
            : undefined;
        ...
        while (_reader.nextField()) {
            ...
            switch (_reader.getFieldNumber()) {
                ...
                case 9:
                    ...
                    _reader.readMessage(_instance.sipStatusHistory, ondewoSip010.SipStatusHistoryResponse.deserializeBinaryFromReader);
                    break;
                case 10:
    ...
    static serializeBinaryToWriter(_instance, _writer) {
        ...
        if (_instance.sipStatusHistory) {
            _writer.writeMessage(9, _instance.sipStatusHistory, ondewoSip010.SipStatusHistoryResponse.serializeBinaryToWriter);
        }
