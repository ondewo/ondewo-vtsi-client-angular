...
export class VoipSessionsClient {
    ...
    createProjectConfigs(requestData, requestMetadata = new GrpcMetadata()) {
        return this.$raw
            .createProjectConfigs(requestData, requestMetadata)
    ...
    getProjectConfigs(requestData, requestMetadata = new GrpcMetadata()) {
        return this.$raw
            .getProjectConfigs(requestData, requestMetadata)
            .pipe(throwStatusErrors(), takeMessages());
    }
    /**
     * Unary call @/ondewo.vtsi.VoipSessions/UpdateProjectConfigs
    ...
    updateProjectConfigs(requestData, requestMetadata = new GrpcMetadata()) {
        return this.$raw
            .updateProjectConfigs(requestData, requestMetadata)
            .pipe(throwStatusErrors(), takeMessages());
    }
    /**
     * Unary call @/ondewo.vtsi.VoipSessions/DeleteProjectConfigs
    ...
    deleteProjectConfigs(requestData, requestMetadata = new GrpcMetadata()) {
        return this.$raw
            .deleteProjectConfigs(requestData, requestMetadata)
            .pipe(throwStatusErrors(), takeMessages());
    }
    /**
     * Unary call @/ondewo.vtsi.VoipSessions/DeployProject
    ...
    deployProject(requestData, requestMetadata = new GrpcMetadata()) {
        return this.$raw
            .deployProject(requestData, requestMetadata)
            .pipe(throwStatusErrors(), takeMessages());
    }
    /**
     * Unary call @/ondewo.vtsi.VoipSessions/UndeployProject
    ...
    undeployProject(requestData, requestMetadata = new GrpcMetadata()) {
        return this.$raw
            .undeployProject(requestData, requestMetadata)
            .pipe(throwStatusErrors(), takeMessages());
    }
    /**
     * Unary call @/ondewo.vtsi.VoipSessions/StartListeners
    ...
    getVoipCallInfo(requestData, requestMetadata = new GrpcMetadata()) {
        return this.$raw
            .getVoipCallInfo(requestData, requestMetadata)
            .pipe(throwStatusErrors(), takeMessages());
    }
    /**
     * Unary call @/ondewo.vtsi.VoipSessions/ListVoipCallInfo
    ...
    listVoipCallInfo(requestData, requestMetadata = new GrpcMetadata()) {
        return this.$raw
            .listVoipCallInfo(requestData, requestMetadata)
            .pipe(throwStatusErrors(), takeMessages());
    }
    /**
     * Unary call @/ondewo.vtsi.VoipSessions/GetAudioFile
...
VoipSessionsClient.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.1.3", ngImport: i0, type: VoipSessionsClient, deps: [{ token: GRPC_VOIP_SESSIONS_CLIENT_SETTINGS, optional: true }, { token: GRPC_CLIENT_FACTORY }, { token: i1.GrpcHandler }], target: i0.ɵɵFactoryTarget.Injectable });
VoipSessionsClient.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.1.3", ngImport: i0, type: VoipSessionsClient, providedIn: 'any' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.1.3", ngImport: i0, type: VoipSessionsClient, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'any' }]
